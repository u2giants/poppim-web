...
export const ALLOWLIST = {
  ...
  '.github/workflows/pii-forward-guard.yml': [1, PROSE],
  '.github/workflows/shared-db-live-proof.yml': [1, PROSE],
  '.github/workflows/sync.yml': [1, PROSE],
  ...
  'scripts/dispatch-production-apply.test.mjs': [1, FIXTURE],
