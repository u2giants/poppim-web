...
| How a new order enters the system (OrderList intake: Adam's PDF to JamieLynn's ERP entry to the OrderList row), ColdLion order history, production history, `COS`, contractual samples, DAVID samples, or ERP code meaning | [`erp-orders-and-source-meaning.md`](erp-orders-and-source-meaning.md) |
