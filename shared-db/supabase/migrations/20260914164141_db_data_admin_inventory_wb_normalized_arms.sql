...
-- relations at call time, so creation succeeded and every call for entity kind
-- character or style_guide failed with "relation does not exist". Warner rows
-- now live in plm.wb_character_normalized and plm.wb_style_guide_normalized.
-- The rest of the function is carried forward unchanged.
