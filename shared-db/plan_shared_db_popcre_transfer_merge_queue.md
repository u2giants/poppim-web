...
| 6. Land canonical identity and external-reference updates | 🟡 in progress | 2026-09-18 | Identity PR updates active instructions (AGENTS, README, HANDOFF, COORDINATOR_INTAKE, branch-workflow doc, workflow comments); historical records keep old URLs (redirected). Pending: merge, all nine sync jobs green, cross-repository skill references. |
