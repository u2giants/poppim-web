...
| 2. Land transfer-compatible repository identity handling | ✅ done | 2026-09-17 | PR #3121, merge `629657fa`. Follow-up pre-transfer gaps (operator-trust association and outcome-evidence repository restriction) closed in the #2530 gap PR. **Step 0 owner authorization is still pending; nothing after Step 2 may start without it.** |
