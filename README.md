...
Live app: **https://pm.designflow.app** · Preview aliases: `pm-dev` / `pm-ci` · Backend repo: `u2giants/directus` (local backend schema: `/worksp/directus/pm-system`) · Siblings: `popcrm-web` (CRM), `popdam-web` (DAM).
